...
| qa-fuzzer | Rust `cw-multitest` integration tests + Node/CosmJS QA runner (`references/qa-runner.md`) | contract-engineer |
| static-analyst | `cargo clippy`/`cargo audit` + the manual pattern scan from `references/audit-checklist.md` | contract-engineer (runs in parallel with qa-fuzzer) |
